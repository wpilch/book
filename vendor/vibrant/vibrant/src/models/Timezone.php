 ...
 * Timezone class.
 *
 * Model class for handling world wide timezones
 *
...
namespace Vibrant\Vibrant\Models;
...
class Timezone extends Model
{
    ...
    {
        $timezones = collect();
        foreach (self::$timezoneList as $label => $value){
            $timezones->push((object)['label' => $label, 'value' => $value]);
        }
        return Collection::make($timezones);
    }
