...
@section('content')
    ...
    'margin_bottom' => '10px'
                ...
                {"row":"new","col_class":"col-sm-6","input":"text","name":"komórka","label":"Telefon komórkowy","placeholder":"Komórka","tooltip_text":"Numer tylko na użytek sekretariatu, używany w nagłych przypadkach."},

                {"row":"same","col_class":"col-sm-6","input":"select","name":"grupa","label":"Grupa","placeholder":"Grupa",
                "items":[]}
                ]',
                'buttons' => '{
