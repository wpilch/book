...
class Persons extends Model
{
    ...
    public static $building_options = ['Biuro ds. nauki i wsp. z zagranicą', 'Biuro ds. ogólnych', 'Biuro ds. studenckich', 'brak', 'Dziekanat', 'Pracownia – Bank Komórek', 'Pracownia Genetyki Molekularnej i Wirusologii', 'Sekcja administracyjno-finansowa', 'Wydz.Biochemii, Biofiz. i Biotechnologii', 'Zakład Biochemii Analitycznej', 'Zakład Biochemii Fizycznej', 'Zakład Biochemii Komórki', 'Zakład Biochemii Ogólnej', 'Zakład Biochemii Porównawczej i Bioanalityki', 'Zakład Biofizyki', 'Zakład Biofizyki - Pracownia Fotobiofizyki', 'Zakład Biofizyki - Pracownia Radiospektroskopii Nowotworów i Radiobiologii', 'Zakład Biofizyki Komórki', 'Zakład Biofizyki Molekularnej', 'Zakład Biofizyki Obliczeniowej i Bioinformatyki', 'Zakład Biologii Komórki', 'Zakład Biotechnologii Medycznej', 'Zakład Biotechnologii Roślin', 'Zakład Fizjologii i Biochemii Roślin', 'Zakład Fizjologii i Biologii Rozwoju Roślin', 'Zakład Immunologii', 'Zakład Mikrobiologii', 'Zespół techniczny']; //Lista zakładów
    public static $title_options = ['-','mgr', 'mgr inż.', 'dr', 'dr inż.', 'dr hab.', 'prof. dr hab.']; // tytuły
    public static $status_options = ['brak', 'doktorant', 'adiunkt', 'asystent', 'asystent naukowy', 'prac. Administracyjny', 'pracwnik inżynieryjno-techniczny', 'profesor emerytowany', 'profesor nadzwyczajny', 'profesor zwyczajny', 'referent techniczny', 'samodzielny biolog', 'samodzielny chemik', 'samodzielny referent techniczny', 'spec. naukowo-techniczny', 'specjalista biolog', 'specjalista informatyk', 'specjalista inż.-techn', 'specjalista inżynieryjno-techniczny', 'st. specjalista naukowo-techniczny', 'starszy referent inż-tech.', 'starszy specjalista', 'starszy specjalista inż-techniczny', 'starszy wykładowca']; // status
    public static $rules = [
        'imię' => 'required',
        'nazwisko' => 'required',
        'grupa' => 'required'
