 ...
 * Password component
 *
 * Component for password input in a form.
 *
 * @group Form
 * @directive include
 * @version 1.0
 ...
 * @managed
 *
 * @param string $name Input name|e=passwordInput
 * @param string $id Input Id, if empty it takes tha same value as $name|o|
 * @param string $label Input label|o|e=Password
 * @param string $label_class Class to modify input label style|o
 * @param string $placeholder Placeholder for the input|o|e=Password
 ...
 * @param bool:boolean $toggle_show Whether or not to include an icon for toggle password visibility, default is true|o|d=true|i=switch:{yes,no}|e=true
...
if($toggle_show === true){
    $attributes .= ' data-toggle=password';
}

?>

@bring('bs_password@1.1.2')
