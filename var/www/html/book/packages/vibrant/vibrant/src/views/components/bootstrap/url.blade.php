 ...
 * Url component
 *
 * Component for url input in a form.
 *
 * @group Form
 * @directive include
 * @version 1.0
 ...
 * @managed
 *
 * @param string $name Input name|e=urlInput
 * @param string $id Input Id, if empty it takes tha same value as $name|o|
 * @param string $label Input label|o|e=Your link
 * @param string $label_class Class to modify input label style|o
 * @param string $placeholder Placeholder for the input|o|e=http://yoursite.com
 * @param string:url $value Predefined value for the input|o|
